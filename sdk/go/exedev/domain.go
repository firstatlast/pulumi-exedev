...
func NewDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.RegisterResource("exedev:index:Domain", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetDomain(ctx *pulumi.Context,
	...
	var resource Domain
	err := ctx.ReadResource("exedev:index:Domain", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Name of the VM to attach the domain to. Changing this replaces the domain.
func (o DomainOutput) Vm() pulumi.StringOutput {
	return o.ApplyT(func(v *Domain) pulumi.StringOutput { return v.Vm }).(pulumi.StringOutput)
}
