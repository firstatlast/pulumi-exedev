...
func NewSshKey(ctx *pulumi.Context,
	...
	var resource SshKey
	err := ctx.RegisterResource("exedev:index:SshKey", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetSshKey(ctx *pulumi.Context,
	...
	var resource SshKey
	err := ctx.ReadResource("exedev:index:SshKey", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Scope the key to VMs carrying this tag. Changing this replaces the key.
func (o SshKeyOutput) Tag() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SshKey) pulumi.StringPtrOutput { return v.Tag }).(pulumi.StringPtrOutput)
}
